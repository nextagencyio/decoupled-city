...
export const metadata: Metadata = {
  title: 'News & Announcements | City of Maplewood',
  description: 'Stay informed with the latest news and announcements from the City of Maplewood.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Stay informed about what is happening in the City of Maplewood.
            </p>
          </div>
        </div>
      </section>

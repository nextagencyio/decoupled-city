...
export const metadata: Metadata = {
  title: 'Services | City of Maplewood',
  description: 'Browse services offered by the City of Maplewood to residents and businesses.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Access city services available to Maplewood residents, businesses, and visitors.
            </p>
          </div>
        </div>
      </section>

...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  const title = (homepageContent as any)?.heroTitle || (homepageContent as any)?.title || 'Welcome to the City of Maplewood'
  ...
  return (
    <section className="relative overflow-hidden bg-primary-900 pt-32 pb-16">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1480714378408-67cf0d13bc1f?w=1800&q=80&fit=crop"
          alt="City skyline"

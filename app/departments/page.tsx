...
export const metadata: Metadata = {
  title: 'Departments | City of Maplewood',
  description: 'Browse city departments and services provided by the City of Maplewood.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Explore the departments that serve the City of Maplewood and its residents.
            </p>
          </div>
        </div>
      </section>

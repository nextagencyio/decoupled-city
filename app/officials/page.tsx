...
export const metadata: Metadata = {
  title: 'City Officials | City of Maplewood',
  description: 'Meet the elected officials and city leadership of the City of Maplewood.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Meet the elected officials and leadership serving the City of Maplewood.
            </p>
          </div>
        </div>
      </section>
          ...
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                City officials will appear here once content is imported.
              </p>
            </div>
          ) : (
